...
// Using Avro Specific generated class is mainly good
// for type safty and convenient getters and setters.
public class SpecificRecordExample {
	...
	public static void main(String[] args) {
		...
		final DatumWriter<Customer> datumWriter = new SpecificDatumWriter<>(Customer.class); // Customer is an Avro SpecificRecord
