...
public class CustomerV1 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public CustomerV1(java.lang.CharSequence first_name, java.lang.CharSequence last_name, java.lang.Integer age, java.lang.Float height, java.lang.Float weight, java.lang.Boolean automated_email) {
   ...
   */
  public static kafka.dev.avro.schemaEvolution.CustomerV1.Builder newBuilder() {
    return new kafka.dev.avro.schemaEvolution.CustomerV1.Builder();
  }
   ...
   * @return A new CustomerV1 RecordBuilder
   */
  public static kafka.dev.avro.schemaEvolution.CustomerV1.Builder newBuilder(kafka.dev.avro.schemaEvolution.CustomerV1.Builder other) {
    return new kafka.dev.avro.schemaEvolution.CustomerV1.Builder(other);
  }
   ...
   * @return A new CustomerV1 RecordBuilder
   */
  public static kafka.dev.avro.schemaEvolution.CustomerV1.Builder newBuilder(kafka.dev.avro.schemaEvolution.CustomerV1 other) {
    return new kafka.dev.avro.schemaEvolution.CustomerV1.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CustomerV1>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(kafka.dev.avro.schemaEvolution.CustomerV1.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(kafka.dev.avro.schemaEvolution.CustomerV1 other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.first_name)) {
        this.first_name = data().deepCopy(fields()[0].schema(), other.first_name);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.dev.avro.schemaEvolution.CustomerV1.Builder setFirstName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.dev.avro.schemaEvolution.CustomerV1.Builder clearFirstName() {
      first_name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.dev.avro.schemaEvolution.CustomerV1.Builder setLastName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.dev.avro.schemaEvolution.CustomerV1.Builder clearLastName() {
      last_name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.dev.avro.schemaEvolution.CustomerV1.Builder setAge(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.dev.avro.schemaEvolution.CustomerV1.Builder clearAge() {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.dev.avro.schemaEvolution.CustomerV1.Builder setHeight(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.dev.avro.schemaEvolution.CustomerV1.Builder clearHeight() {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.dev.avro.schemaEvolution.CustomerV1.Builder setWeight(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.dev.avro.schemaEvolution.CustomerV1.Builder clearWeight() {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.dev.avro.schemaEvolution.CustomerV1.Builder setAutomatedEmail(boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.dev.avro.schemaEvolution.CustomerV1.Builder clearAutomatedEmail() {
