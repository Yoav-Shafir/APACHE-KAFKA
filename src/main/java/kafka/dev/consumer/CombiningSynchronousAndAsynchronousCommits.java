...
public class CombiningSynchronousAndAsynchronousCommits {
		...
		try {
		    ...
		    while (true) {
		    	...
		    	try {
		    		...
		    		// While everything is fine, we use commitAsync. It is faster, 
		    		// and if one commit fails, the next commit will serve as a retry.
		    		consumer.commitSync();
